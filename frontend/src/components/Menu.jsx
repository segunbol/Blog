...
const Menu = () => {
  ...
  return (
    <div>
      <aside id="default-sidebar" className="fixed top-[72px] right-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
